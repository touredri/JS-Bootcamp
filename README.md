...
# 📖 [Js BootCamp] <a name="about-project"></a>

**[Js BootCamp]** is an online full course to learn JavaScript with interactions and practices
...
```sh
  cd my-folder
  https://github.com/touredri/JS-Bootcamp
```
